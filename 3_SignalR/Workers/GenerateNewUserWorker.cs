...
public class GenerateNewUserWorker : BackgroundService
{
    private readonly IHttpClientFactory _factory;
    private readonly IHubContext<SyncHub> _hubContext;
    private readonly ILogger _logger;

    public GenerateNewUserWorker(IHttpClientFactory factory, ILogger<GenerateNewUserWorker> logger, 
    ...
    private async Task<NewUser> GetUser()
    {
        ...
        using (var client = _factory.CreateClient())
        {
            ...
            var newUser = JsonSerializer.Deserialize<NewUser>(response);
            return newUser;
        }
    }
}
...
public class Result
{
    ...
    [JsonPropertyName("registered")] public Registered Registered { get; set; }
